...
struct SymbolTable
{
	...
	SymbolTable(bool isScopeOfLoop, int maximumOffsetOfBlock, std::string typeOfReturn = "") :table(), isScopeOfLoop(isScopeOfLoop), maximumOffsetOfBlock(maximumOffsetOfBlock), typeOfReturn(typeOfReturn)
	{
